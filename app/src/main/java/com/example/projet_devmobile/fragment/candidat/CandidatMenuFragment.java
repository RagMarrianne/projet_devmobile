...
public class CandidatMenuFragment extends Fragment {
    ...
    public CandidatMenuFragment() {
        // Required empty public constructor
    }

    public static CandidatMenuFragment newInstance(Map<String, Object> criteres) {
        Bundle args = new Bundle();
        args.putSerializable(FILTRE, (Serializable) criteres);
        CandidatMenuFragment fragment = new CandidatMenuFragment();
    ...
    private void addOffreView(String idOffre, Offre offre){
        ...
        offreLayout.setOnClickListener(onClickListener -> requireActivity()
                ...
                .replace(R.id.menuContent, AfficherOffreFragment.newInstance(idOffre))
                .commit());
