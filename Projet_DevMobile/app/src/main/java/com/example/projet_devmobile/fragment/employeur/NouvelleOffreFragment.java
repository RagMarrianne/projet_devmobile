    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        ButtonSetLayout.ButtonParam  deposerOffreBouton = new ButtonSetLayout.ButtonParam("Déposer","#5CE98C", new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                data.put("pseudoemployeur",db.collection("employeurs").document(employeurPseudo));
                ...
                requireActivity().getSupportFragmentManager().beginTransaction().remove(NouvelleOffreFragment.this).replace(R.id.menuContent, new EmployeurMenuFragment()).commit();
            }
        });
        ...
        LinearLayout offreInfo = view.findViewById(R.id.offreInfo);
